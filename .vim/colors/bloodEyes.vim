...
" Site: https:/github.com/christophermca/bloodEyes
" Version:      0.0.1
...
let colors_name = "BloodEyes"

" Vim >= 7.0 specific colors
if version >= 700
  hi iCursor      guifg=#000000 guibg=#d0d0d0 ctermfg=0 ctermbg=252
  hi CursorLine   guibg=#262626 gui=NONE ctermbg=160 cterm=NONE
...
" General colors
hi Cursor         guifg=# guibg=#d0d0d0 ctermfg=9 ctermbg=5
hi NonText        guifg=#5f5fff ctermfg=232
hi Normal         guifg=#bcbcbc guibg=#1c1c1c ctermfg=196 ctermbg=255
hi CursorLineNr   guifg=#ffff00 guibg=NONE ctermfg=88 ctermbg=NONE
hi colorColumn    guibg=#000080 ctermbg=4
hi Directory      guifg=#00ffff guibg=NONE ctermfg=14 ctermbg=NONE
hi LineNr         guifg= guibg=NONE ctermfg=248 ctermbg=NONE
...
hi Identifier     guifg=#00afff ctermfg=0
hi Function       guifg=#df8700 ctermfg=0
hi Type           guifg=#87dfff gui=NONE ctermfg=0
